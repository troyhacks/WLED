...
//colors.cpp
// Merge: CRGB ColorFromPaletteWLED(const CRGBPalette16& pal, unsigned index, uint8_t brightness=255, TBlendType blendType=LINEARBLEND);
// Merge: #define ColorFromPalette ColorFromPaletteWLED // override fastled version
